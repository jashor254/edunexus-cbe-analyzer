...
const WEEKS = [
  {
    ...
    sub: 'Close the Critical Gaps',
    focus: 'Mathematics, Integrated Science',
    daily: '45 min/day',
    goal: 'Build foundational competency in Maths and Science — close gaps before Term 2.',
    ...
    dotColor: 'bg-red-500',
    activities: [
      'Review fractions, decimals and percentages — 20 problems/day',
      'Basic algebra: simplify and solve linear equations',
      'Integrated Science: draw and label 3 key diagrams from class notes',
    ],
    schedule: [
      { time: 'MORNING', task: 'Mathematics', dur: '45 min', bg: 'bg-white/10' },
      { time: 'AFTERNOON', task: 'Science', dur: '30 min', bg: 'bg-white/10' },
  ...
  },
  {
    ...
    days: '8–14',
    title: 'BUILDING WEEK',
    sub: 'Consolidate and Close Gaps',
    focus: 'Pre-Technical, Agriculture',
    daily: '30 min/day',
    goal: 'Push developing subjects toward Meeting Expectations — reduce revision gaps.',
    ...
    activities: [
      'Pre-Technical: hands-on design and construction practice daily',
      'Agriculture: field engagement and nutritional case studies',
      'Apply learning to real-life situations at home',
    ],
    schedule: null,
  },
  {
    ...
    sub: 'Sustain the Strengths',
    focus: 'English, Social Studies',
    daily: '20 min/day',
    goal: 'Advance strong subjects toward Level 4 — explore extension opportunities.',
    ...
    activities: [
      'Write one essay per week on a chosen topic',
      'Read one newspaper article daily — summarize in 3 sentences',
      'Practice debate: argue both sides of a topic',
    ],
    schedule: null,
  },
]
