-- =============================================================================
-- EDUNEXUS CBE ANALYZER — UNIFIED SUPABASE SCHEMA
-- Run this in the Supabase SQL Editor (Dashboard → SQL Editor → New Query)
-- Uses DROP … CASCADE so safe to re-run on an existing database
-- =============================================================================
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.1  PROFILES  (public mirror of auth.users — one row per Supabase Auth user)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.2  USERS  (extended user data — referrals, onboarding, free analyses)
-- ─────────────────────────────────────────────────────────────────────────────
CREATE TABLE users (
  id                        UUID        PRIMARY KEY REFERENCES auth.users(id) ON DELETE CASCADE,
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.5  STRAND ASSESSMENTS (topic-level granularity)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.8  LEARNER PROFILES (AI-generated learning style profiles)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.9  CAREER INTELLIGENCE (AI-enriched career database)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.10  CAREERS (searchable/cached career records)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.11  DYNAMIC CAREERS (admin-managed/generated careers)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.13  CAREER REVIEW QUEUE (expert review pipeline)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.14  PATHWAY ANALYSES (recommended pathway history)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.15  PAYMENTS  (Paystack transactions)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.16  TOKEN BALANCES  (current token wallet — primary token system)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.17  USER TOKENS  (legacy token allocation rows — kept for compatibility)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.18  TOKEN USAGE  (audit log of every token spend)
-- ─────────────────────────────────────────────────────────────────────────────
...
CREATE TABLE subscriptions (
  ...
  user_id       UUID        NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  plan          TEXT        NOT NULL
                            CHECK (plan IN ('starter','term','premium','school')),
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.20  COMPASS SESSIONS  (Learning Compass persistent state)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.21  COMPASS MESSAGES  (chat history for pedagogy tracking)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.22  USER FEEDBACK  (NPS + feature ratings)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.24  AI USAGE  (monthly counters for rate limiting)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.25  AI USAGE LOGS  (per-call audit log — used by rate-limit.ts)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.26  FEATURE REQUESTS  (product feedback board)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.28  USER CLEANUP STATS  (GDPR cron job audit)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 2.29  WEBHOOK ERRORS  (Paystack webhook failure log)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- =============================================================================
-- 4. TRIGGER — auto-create profiles + users rows on Supabase Auth signup
-- =============================================================================
...
BEGIN
  ...
  -- Create initial token_balances row
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5.1  deduct_tokens — atomically spend tokens from token_balances
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5.2  create_user_with_referral — called on signup to wire up referral bonuses
-- ─────────────────────────────────────────────────────────────────────────────
...
BEGIN
  -- Look up the auth.users row by email
  ...
  -- Get user record (created by trigger)
  ...
  IF p_referred_by_code IS NOT NULL AND p_referred_by_code != '' THEN
    ...
    IF v_referrer_id IS NOT NULL THEN
      -- Record which code this user used
      UPDATE users
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5.4  use_free_analysis — consume one free analysis slot
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5.5  expire_free_analyses — cron: zero out expired free analyses
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5.6  mark_users_for_deletion — cron: flag users inactive > 90 days
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- 5.7  cleanup_marked_users — cron: delete users marked for 30+ days
--      Returns summary stats for the cron response
-- ─────────────────────────────────────────────────────────────────────────────
...
-- Public read-only tables (no RLS needed for read, but still restrict writes)
...
-- =============================================================================
-- 7. GRANT SERVICE ROLE BYPASS (service_role key skips RLS)
--    No action needed — Supabase service_role bypasses RLS by default.
--    These GRANT statements ensure the anon/authenticated roles can call RPCs.
-- =============================================================================
