...
*Assembly order for the printed/exported edition: Half-Title → Title Page → Copyright Page → Table of Contents → Preface (00-preface.md) → Chapters 1–6. This file is a source document for that front matter, not itself part of the reading sequence.*
