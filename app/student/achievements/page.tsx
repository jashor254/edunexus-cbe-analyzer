...
//
// Sprint 6 — self-serve "my own Achievements" entry point, no [learnerId]
// in the URL, mirroring app/student/blueprint/page.tsx exactly.

import { redirect } from 'next/navigation'
import { createClient } from '@/utils/supabase/server'
import { resolveOwnCoreLearnerId } from '@/lib/core/identity'

export default async function StudentAchievementsIndexPage() {
    ...
    return (
      <div className="max-w-2xl mx-auto py-6 px-4">
        <div role="alert" className="bg-white rounded-2xl border border-gray-100 p-6 text-center space-y-2">
          <p className="text-sm font-black text-gray-900">Achievements unavailable</p>
  ...
  redirect(`/student/achievements/${coreLearnerId}`)
}
