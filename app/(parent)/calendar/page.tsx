...
// Sprint 5 (Parent Experience Convergence) — family-wide calendar and
// announcements, across every class any of the parent's linked children
// belong to. Zero new backend: /api/student/calendar and
// /api/student/announcements already resolve `.or(user_id.eq,
// parent_user_id.eq)` — a parent calling them gets exactly this data
// today, just with no page that ever called them. Read-only, identical
// data shape and rendering to app/student/calendar/page.tsx — no submit
// or write actions ever existed on that page either, so nothing is
// stripped, only the audience and the "back" destination differ.
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Dates, deadlines, and updates from your children&apos;s teachers</p>
      </div>
