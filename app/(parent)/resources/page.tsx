...
// app/(parent)/resources/page.tsx
// Sprint 5 (Parent Experience Convergence) — family-wide class resources
// (notes/files), across every class any of the parent's linked children
// belong to. Zero new backend: /api/student/resources and
// /api/student/materials already resolve `.or(user_id.eq,
// parent_user_id.eq)` — read-only, identical to
// app/student/resources/page.tsx, no write/download-management actions
// stripped because none existed.
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Notes and files your children&apos;s teachers have shared</p>
      </div>
