      ...
      <div className="relative bg-slate-900 border border-white/10 rounded-3xl overflow-hidden">
        ...
        <div className="px-4 py-3 border-t border-white/10 bg-white/3 flex items-center gap-2">
          <div className="flex-1 bg-white/5 border border-white/10 rounded-xl px-3 py-2">
            <span className="text-[11px] text-white/30">Uliza swali lolote la CBC...</span>
          </div>
          <button className="w-8 h-8 bg-linear-to-r from-amber-500 to-orange-500 rounded-xl flex items-center justify-center shrink-0">
      ...
      <div className="relative bg-slate-900 border border-white/10 rounded-3xl overflow-hidden">
        ...
        <div className="px-4 py-3 border-t border-white/10 bg-white/3">
          ...
          <div className="flex gap-2">
            ...
            <button className="flex-1 flex items-center justify-center gap-1.5 bg-white/5 border border-white/10 text-white/60 py-2 rounded-xl text-[11px] font-black">
        ...
        <div className="px-4 py-4 space-y-4">
          ...
          <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-3">
            <div className="flex items-center justify-between">
              ...
              <button className="text-[10px] bg-red-500/20 border border-red-500/30 text-red-300 px-2 py-1 rounded-lg font-black">
                Send Reminder
              </button>
            </div>
          </div>
        ...
        <div className="px-4 py-3 border-b border-white/10 bg-white/5">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[10px] text-white/40">Based on Brian&apos;s actual performance</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-4 py-4 space-y-3">
          {careers.map((c, i) => (
            <div key={c.title} className={`${c.bgColor} border ${c.borderColor} rounded-2xl p-3`}>
              ...
              {i === 0 && (
                <button className={`mt-2 w-full text-[10px] font-black bg-linear-to-r ${c.color} text-white py-1.5 rounded-xl`}>
                  Explore Path
                </button>
              )}
            </div>
          ...
          <p className="text-[10px] text-white/30 text-center">200+ careers · Updated 2026 🇰🇪</p>
        </div>
      </div>
    </div>
  )
    ...
    <div className="relative w-full">
      ...
      <div className="relative bg-slate-900 border border-white/10 rounded-3xl overflow-hidden">
        ...
        <div className="px-4 py-4 space-y-3">
          ...
          <div className="flex gap-2">
            <button className="flex-1 flex items-center justify-center gap-1.5 bg-linear-to-r from-blue-500 to-indigo-500 text-white py-2 rounded-xl text-[11px] font-black">
              <Download className="w-3 h-3" /> Download PDF
            </button>
            <button className="flex-1 flex items-center justify-center gap-1.5 bg-white/5 border border-white/10 text-white/60 py-2 rounded-xl text-[11px] font-black">
