      ...
      <div className="max-w-2xl mx-auto p-6 print:p-8">
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 text-center">
          <p className="text-xs text-slate-400 leading-relaxed">
            This report was generated by EduNexus AI based on assessment data entered by the parent/guardian. All recommendations are advisory — final educational decisions rest with parents, teachers, and students.
          </p>
          <p className="text-xs text-slate-400 mt-1">
            EduNexus · AI-Powered Education · edunexus.co.ke · Made in Kenya 🇰🇪
          </p>
        </div>
