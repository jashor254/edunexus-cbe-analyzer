      ...
      <div className="max-w-2xl mx-auto p-6 print:p-8">
        ...
        <div className="text-center mb-8 pb-6 border-b border-white/10 print:border-gray-300">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-white/50 print:text-gray-500 font-medium">Learner Intelligence Report</div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-slate-500 mt-2">
            ...
            <span>Generated by EduNexus AI · Reviewed by parent · {new Date().toLocaleDateString('en-KE')}</span>
          </div>
        </div>
        ...
        <div className="text-center pt-6 border-t border-white/10 print:border-gray-200">
          <p className="text-xs text-white/30 print:text-gray-400">
            Report generated by EduNexus from available learner evidence · edunexus.co.ke
          </p>
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 text-center">
          <p className="text-xs text-slate-400 leading-relaxed">
            This report reflects your child's actual assessment scores. All recommendations are advisory — final educational decisions rest with parents, teachers, and students.
          </p>
          <p className="text-xs text-slate-400 mt-1">
            EduNexus · edunexus.co.ke · Made in Kenya 🇰🇪
          </p>
        </div>
